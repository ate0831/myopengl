...
impl Shader {
    ...
    pub fn new(vertex_path:&str,fragment_path:&str) -> Shader {
        ...
        let mut vertex_file =File::open(vertex_path)
            .unwrap_or_else(|_| panic!("faile to open file : {}",vertex_path));
        let mut fragment_file =File::open(fragment_path)
            .unwrap_or_else(|_| panic!("faile to open file : {}",fragment_path));
    ...
    unsafe fn check_compile_errors(&self, shader:u32, type_:&str){
        ...
        info_log.set_len(1024-1);   //subtract 1 to skip the null character
        if type_ != "PROGRAM" {
    ...
    pub fn with_geometry_shader(
        ...
        let mut geometry_file =File::open(geometry_path)
            .unwrap_or_else(|_| panic!("faile to open file : {}",geometry_path));
